...
RSpec.describe Captain::PromptRenderer do
  ...
  let(:template_path) { Rails.root.join('lib', 'captain', 'prompts', "#{template_name}.liquid") }
  ...
  describe 'snippet rendering' do
    let(:snippets_dir) { Rails.root.join('lib/captain/prompts/snippets') }
  ...
  describe '.load_template' do
    ...
    it 'constructs correct template path' do
      expected_path = Rails.root.join('lib/captain/prompts/my_template.liquid')
