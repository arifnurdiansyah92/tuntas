    ...
    context 'when conversation exists' do
      ...
      context 'when handoff fails' do
        before do
          ...
          exception_tracker = instance_double(TuntasExceptionTracker)
        ...
        it 'captures exception' do
          exception_tracker = instance_double(TuntasExceptionTracker)
          expect(TuntasExceptionTracker).to receive(:new).with(instance_of(StandardError)).and_return(exception_tracker)
