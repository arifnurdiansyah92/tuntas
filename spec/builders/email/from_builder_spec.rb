...
RSpec.describe Email::FromBuilder do
  ...
  describe '#build' do
    ...
    context 'when inbox is an email channel' do
      ...
      context 'with IMAP enabled and Tuntas SMTP and channel is verified_for_sending' do
        before do
      ...
      context 'with IMAP enabled and Tuntas SMTP and channel is not verified_for_sending' do
        before do
      ...
      context 'with forwarding and Tuntas SMTP and channel is verified_for_sending' do
        before do
      ...
      context 'with forwarding and Tuntas SMTP and channel is not verified_for_sending' do
