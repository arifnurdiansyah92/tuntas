...
RSpec.describe 'Devise::Mailer' do
  describe 'notify' do
    ...
    it 'has the correct header data' do
      expect(mail.reply_to).to contain_exactly('accounts@tuntas.id')
    ...
    it 'shows the default confirmation state' do
      ...
      expect(mail_body).to include('Welcome to Tuntas. We just need to verify your email address before you can start using your account.')
    ...
    context 'when there is an inviter' do
      ...
      it 'refers to the inviter and their account' do
        ...
        expect(mail_body).to include("#{inviter_val.name} invited you to join the #{account.name} workspace on Tuntas.")
