...
describe Whatsapp::IncomingMessageWhatsappCloudService do
  describe '#perform' do
    ...
    context 'when message is a reply (has context)' do
      ...
      context 'when the original message exists in Tuntas' do
      ...
      context 'when the original message does not exist in Tuntas' do
  ...
  def stub_media_url_request
    stub_request(
      ...
      body: {
        ...
        url: 'https://tuntas-assets.local/sample.png',
        mime_type: 'image/jpeg',
        sha256: 'sha256',
        file_size: 'SIZE',
        id: 'b1c68f38-8734-4ad3-b4a1-ef0c10d683'
