...
describe('useAvailability', () => {
  const originalWindow = window.tuntasWebChannel;
  ...
  afterEach(() => {
    window.tuntasWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.tuntasWebChannel changes', () => {
