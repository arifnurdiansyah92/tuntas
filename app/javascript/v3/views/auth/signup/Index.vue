...
const isATuntasInstance = computed(
  () => globalConfig.value.installationName === 'Tuntas'
);

onBeforeMount(() => {
  isLoading.value = isATuntasInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isATuntasInstance }"
    >
