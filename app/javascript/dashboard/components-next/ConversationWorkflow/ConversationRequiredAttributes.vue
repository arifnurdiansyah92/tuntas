...
const { t } = useI18n();
const { currentAccount, accountId, isOnTuntasCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnTuntasCloud.value);
const i18nKey = computed(() =>
  isOnTuntasCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
