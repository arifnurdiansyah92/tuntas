export const ONGOING_CAMPAIGN_EMPTY_STATE_CONTENT = [
  ...
  },
  {
    ...
    message: 'Hi! Tuntas here. Need help setting up? Let me know!',
    campaign_status: 'active',
    enabled: false,
    campaign_type: 'ongoing',
    trigger_rules: {
      url: 'https://{*.}?tuntas.id/apps/account/*/settings/inboxes/new/',
      time_on_page: 10,
    },
    trigger_only_during_business_hours: false,
...
export const ONE_OFF_CAMPAIGN_EMPTY_STATE_CONTENT = [
  {
    ...
    message:
      'Hello! Enjoying our product? Share your feedback on G2 and earn a $25 Amazon coupon: https://tuntas.id/docs',
    campaign_status: 'active',
    enabled: true,
