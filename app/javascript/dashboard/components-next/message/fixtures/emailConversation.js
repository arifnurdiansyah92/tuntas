...
export default camelcaseKeys(
  [
      ...
      attachments: [
        {
          ...
          account_id: 51,
          extension: null,
          data_url: 'https://tuntas.id/docs',
          thumb_url: 'https://tuntas.id/docs',
          file_size: 841909,
          width: null,
          height: null,
        },
    ...
    },
    {
      ...
      status: 'sent',
      source_id:
        'conversation/758d1f24-dc76-4abc-9c41-255ed8974f8e/messages/60914@reply.tuntas.dev',
      content_type: 'text',
      content_attributes: {
        cc_emails: [],
        bcc_emails: [],
      ...
      sender: {
        ...
        name: 'Alex',
        available_name: 'Alex',
        avatar_url: 'https://tuntas.id/docs',
        type: 'user',
        availability_status: 'online',
        thumbnail: 'https://tuntas.id/docs',
      },
    },
    {
      id: 60915,
    ...
    },
    {
      ...
      content_type: 'text',
      source_id:
        'conversation/758d1f24-dc76-4abc-9c41-255ed8974f8e/messages/60916@reply.tuntas.dev',
      processed_message_content:
    ...
    },
    {
      ...
      content_attributes: {
        email: {
          ...
          from: ['alex@paperlayer.test'],
          html_content: {
            full: '<div dir="ltr">Great we were looking for something in a different finish see image attached<br><br><img src="https://tuntas.id/docs" alt="image.png" width="472" height="305"><br><div><br></div><div>Let me know if you have different finish options?<br><br>Best Regards</div></div><br><div class="gmail_quote gmail_quote_container"><div dir="ltr" class="gmail_attr">On Wed, 4 Dec 2024 at 17:17, Sam from CottonMart &lt;<a href="mailto:sam@cottonmart.test">sam@cottonmart.test</a>&gt; wrote:<br></div><blockquote class="gmail_quote" style="margin:0px 0px 0px 0.8ex;border-left:1px solid rgb(204,204,204);padding-left:1ex">  <p>Dear Alex,</p>\n<p>Please find attached images of our cotton fabric samples. Let us know if you&#39;d like physical samples sent to you.</p>\n<p>Warm regards,<br>\nSam</p>\n\n    attachment [<a href="https://tuntas.id/docs" target="_blank">click here to view</a>]\n</blockquote></div>\n',
            reply:
              'Great we were looking for something in a different finish see image attached\n\n[image.png]\n\nLet me know if you have different finish options?\n\nBest Regards\n\nOn Wed, 4 Dec 2024 at 17:17, Sam from CottonMart <sam@cottonmart.test> wrote:\n>',
            quoted:
              'Great we were looking for something in a different finish see image attached\n\n[image.png]\n\nLet me know if you have different finish options?\n\nBest Regards',
