...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about Tuntas?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://tuntas.dev/invoice.pdf'),
      getAttachment('file', 'https://tuntas.dev/logs.txt'),
      getAttachment('file', 'https://tuntas.dev/contacts.xls'),
      getAttachment('file', 'https://tuntas.dev/customers.csv'),
      getAttachment('file', 'https://tuntas.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://tuntas.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://tuntas.dev/all-files.tar'),
      getAttachment(
        'audio',
