...
const brokenImageMessage = computed(() =>
  getMessage({
    content: null,
    attachments: [getAttachment('image', 'https://tuntas.dev/broken.png')],
    ...baseSenderData.value,
  })
);
...
const attachmentsOnly = computed(() =>
  getMessage({
    content: null,
    attachments: [
      getAttachment('image', 'https://tuntas.dev/broken.png'),
      getAttachment(
        'video',
        'https://videos.pexels.com/video-files/1739010/1739010-hd_1920_1080_30fps.mp4'
      ),
...
const singleFile = computed(() =>
  getMessage({
    content: null,
    attachments: [getAttachment('file', 'https://tuntas.dev/all-files.tar')],
    ...baseSenderData.value,
  })
);
