export default [
  {
    ...
    name: 'Premium SLA',
    description:
      'SLA for tuntas cloud premium and self-hosted premium customers.  SLA for tuntas cloud premium and self-hosted premium customers',
  ...
  },
  {
    ...
    name: 'Enterprise SLA',
    description:
      'SLA for tuntas enterprise and self-hosted enterprise customers.',
  ...
  },
  {
    id: 3,
    name: 'Business SLA',
    description: 'Tuntas cloud Business and self-hosted Business customers SLA',
