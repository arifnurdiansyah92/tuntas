...
describe('#mutations', () => {
  describe('#SET_CONTACTS', () => {
    it('set contact records', () => {
      ...
      mutations[types.SET_CONTACTS](state, [
        { id: 2, name: 'contact2', email: 'contact2@tuntas.id' },
        { id: 1, name: 'contact1', email: 'contact1@tuntas.id' },
      ]);
      expect(state.records).toEqual({
        1: {
          id: 1,
          name: 'contact1',
          email: 'contact1@tuntas.id',
        },
        2: {
          id: 2,
          name: 'contact2',
          email: 'contact2@tuntas.id',
        },
      });
  ...
  describe('#SET_CONTACT_ITEM', () => {
    it('push contact data to the store', () => {
      const state = {
        records: {
          1: { id: 1, name: 'contact1', email: 'contact1@tuntas.id' },
        },
        sortOrder: [1],
      };
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact1', email: 'contact1@tuntas.id' },
        2: { id: 2, name: 'contact2', email: 'contact2@tuntas.id' },
      });
  ...
  describe('#EDIT_CONTACT', () => {
    it('update contact', () => {
      ...
      expect(state.records).toEqual({
        1: { id: 1, name: 'contact2', email: 'contact2@tuntas.id' },
      });
    });
