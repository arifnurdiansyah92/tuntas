class Email::FromBuilder < Email::BaseBuilder
  ...
  def build
    ...
    from_email = case email_channel_type
                 when :standard_imap_smtp,
                      ...
                      :forwarding_own_smtp
                   channel.email
                 when :imap_tuntas_smtp,
                      :forwarding_tuntas_smtp
  ...
  def email_channel_type
    ...
    return :imap_tuntas_smtp if imap_enabled_without_smtp?
    return :forwarding_own_smtp if forwarding_with_own_smtp?
    return :forwarding_tuntas_smtp if forwarding_without_smtp?
