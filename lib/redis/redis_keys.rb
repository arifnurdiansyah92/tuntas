module Redis::RedisKeys
  ...
  TUNTAS_INSTALLATION_ONBOARDING = 'TUNTAS_INSTALLATION_ONBOARDING'.freeze
  TUNTAS_INSTALLATION_CONFIG_RESET_WARNING = 'TUNTAS_CONFIG_RESET_WARNING'.freeze
  LATEST_TUNTAS_VERSION = 'LATEST_TUNTAS_VERSION'.freeze
